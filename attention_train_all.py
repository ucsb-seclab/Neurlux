...
def get_model(vocab_size):
    ...
    x = Dropout(0.25)(x) ## increase to .4?
...
if __name__ == '__main__':
    ...
    x, y, benign, malicious, null_count_b, null_count_m = load_data(benign_pickle, malicious_pickle, balance=True)
    ...
    retest(tokenizer, model, 'ember_cuckoo_feature_extract/ember_cuckoo_all_benign.pickle', 'ember_cuckoo_feature_extract/ember_cuckoo_all_malicious.pickle', 'test_dataset')
    retest(tokenizer, model, 'ember_cuckoo_feature_extract/ember_cuckoo_all_benign.pickle', 'ember_cuckoo_feature_extract/ember_cuckoo_all_malicious.pickle', 'test_dataset_no_null', no_null=True)
    retest(tokenizer, model, 'wild_lastline_feature_extract/wild_lastline_all_benign.pickle', 'wild_lastline_feature_extract/wild_lastline_all_malicious.pickle', 'test_sandbox')
    retest(tokenizer, model, 'wild_lastline_feature_extract/wild_lastline_all_benign.pickle', 'wild_lastline_feature_extract/wild_lastline_all_malicious.pickle', 'test_sandbox_no_null', no_null=True)
    retest(tokenizer, model, 'ember_lastline_feature_extract/ember_lastline_all_benign.pickle', 'ember_lastline_feature_extract/ember_lastline_all_malicious.pickle', 'test_dataset_and_sandbox')
    retest(tokenizer, model, 'ember_lastline_feature_extract/ember_lastline_all_benign.pickle', 'ember_lastline_feature_extract/ember_lastline_all_malicious.pickle', 'test_dataset_and_sandbox_no_null', no_null=True)

...
file_tag = "file"
benign = pd.read_pickle('file_benign.pickle')
malicious = pd.read_pickle('file_malicious.pickle')
...
print("SETTING EPOCHS TO 1!!!!!!!!")
model.load_weights("{}_checkpoint".format(file_tag))
epochs=1

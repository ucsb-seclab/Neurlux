...
file_tag = "api_list"
benign = pd.read_pickle('api_list_benign.pickle')
malicious = pd.read_pickle('api_list_malicious.pickle')
...
print("mal len: {}", len(mal_text))
print("benign len: {}", len(benign_text))
